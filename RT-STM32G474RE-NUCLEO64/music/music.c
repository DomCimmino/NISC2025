...
// Durate (ms) - corrette per il ritmo originale
static int pvec[BA_SIZE] = {
  // "We are the champions, my friends"
  1500, 300, 300, 500, 800,
  500, 500, 1500,
  ...
  // "We are the champions" (ripetizione)
  700, 700, 300, 700, 800,

  // "No time for losers"
  700, 700, 300, 700, 700, 300,

  // "'Cause we are the champions... of the world!"
  700, 700, 300, 700, 700, 1500,
  700, 300, 1500
};


// Sine LUT per DAC (12-bit, centrata su 2047)
...
static GPTConfig gpt6cfg1 = {
  .frequency    = 2*DAC_BUFFER_SIZE*vec[0],
  .callback     = NULL,
...
void playMusic(void){
  int cont = 0;
  while(true){
        if(cont == BA_SIZE) break;

        /* Update GPT frequency before starting */
        gpt6cfg1.frequency = 2 * DAC_BUFFER_SIZE * vec[cont];
        gptStart(&GPTD6, &gpt6cfg1);
        ...
        chThdSleepMilliseconds(pvec[cont]);
        gptStopTimer(&GPTD6);
